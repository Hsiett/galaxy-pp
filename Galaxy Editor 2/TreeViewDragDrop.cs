...
namespace Galaxy_Editor_2
{
	...
	public class TreeViewDragDrop : System.Windows.Forms.TreeView
	{
        ...
        /// <summary>
        /// Occurs before an item is dragged and dropped onto another.
        /// </summary>
        [
        Description("Occurs before an item is dragged and dropped onto another."),
        ]
        public event DragCompletionValidEventHandler DragCompleteValid;
        ...
        public delegate void MouseDoubleClickInterceptEventHandler(TreeViewDragDrop sender, MouseEventArgs e, ref bool handled);

	    public event MouseDoubleClickInterceptEventHandler MouseDoubleClickIntercept;
        protected override void OnMouseDoubleClick(MouseEventArgs e)
        {
            if (MouseDoubleClickIntercept != null)
            {
                bool handled = false;
                MouseDoubleClickIntercept(this, e, ref handled);
                if (handled) return;
            }
    ...
    public delegate void DragCompletionValidEventHandler(object sender, DragCompletionValidEventArgs e);
	...
	public class DragCompleteEventArgs : EventArgs
	{
        ...
        public TreeNode CloneNode { get; set; }
        public TreeNode OldParent { get; set; }
        public TreeNode DraggedOn { get; set; }
    ...
    public class DragCompletionValidEventArgs : DragCompleteEventArgs
    {
        public bool Cancel;
    }
